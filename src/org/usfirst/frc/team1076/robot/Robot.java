...
public class Robot extends IterativeRobot {
	...
	Motor leftMotor = Hardware.Motors.talonSRX(0).invert();
	Motor rightMotor = Hardware.Motors.talonSRX(1);
	Motor frontMotor = Hardware.Motors.talonSRX(0);
	Motor backMotor = Hardware.Motors.talonSRX(1);
...
//	TeleopCommand teleopCommand = new TeleopCommand(gamepad, frontBack, leftRight);
	TankDrive tank = new TankDrive(leftMotor, rightMotor);
